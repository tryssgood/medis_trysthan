<nav class="sidebar-nav">
    ...
    <ul>
        ...
        <li>
            <a href="patients.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'doctor\patients.php' ? 'active' : ''; ?>">
                <i class="fas fa-users"></i> Daftar Pasien
            </a>
        </li>
        <li>
            <a href="medical_records.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'doctor\medical_records.php' ? 'active' : ''; ?>">
                <i class="fas fa-notes-medical"></i> Rekam Medis
            </a>
        </li>
        <li>
...
<?php endif; ?>
        ...
        <li>
            <a href="patient/profile.php" class="<?php echo strpos($_SERVER['PHP_SELF'], 'patient/profile.php') !== false ? 'active' : ''; ?>">
        ...
        <li>
            <a href="patient/prescriptions.php" class="<?php echo strpos($_SERVER['PHP_SELF'], 'patient/prescriptions.php') !== false ? 'active' : ''; ?>">

...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3><i class="fas fa-notes-medical"></i> Riwayat Rekam Medis</h3>
                </div>
                <div class="card-body">
                        ...
                        <div class="medical-record-item">
                            ...
                            <div class="record-content">
                                <div class="record-section">
                                    <h4><i class="fas fa-comment-medical"></i> Keluhan</h4>
                    ...
                    <div class="no-data">
                        ...
                        <p>Anda belum memiliki riwayat rekam medis. Silakan kunjungi dokter untuk pemeriksaan.</p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
